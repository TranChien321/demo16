package com.codegym.demo16.configs;
...
@EnableJpaRepositories(basePackages = "com.codegym.demo16.repositories") // Adjust the package to your repository location
public class JpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        emf.setPackagesToScan("com.codegym.demo16.models"); // nơi đặt @Entity
